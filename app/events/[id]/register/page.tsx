      ...
      <section className="animate-fade-in">
        <GlassCard enhanced className="py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-foreground/70">Register for this event</p>
          </div>
        </GlassCard>
      </section>
        ...
        <div className="lg:col-span-1">
          <GlassCard enhanced className="sticky top-24">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-foreground/60 text-sm mb-1">📅 Date</h3>
                <p className="text-foreground font-medium">{event.date}</p>
              </div>
              <div>
                <h3 className="text-foreground/60 text-sm mb-1">🕐 Time</h3>
                <p className="text-foreground font-medium">{event.time}</p>
              </div>
              <div>
                <h3 className="text-foreground/60 text-sm mb-1">💵 Fee</h3>
                <p className="text-foreground font-medium">{event.fee}</p>
              </div>
              <div>
                <h3 className="text-foreground/60 text-sm mb-1">👥 Capacity</h3>
                <p className="text-foreground font-medium">{event.capacity}</p>
              </div>
              <div>
                <h3 className="text-foreground/60 text-sm mb-1">📍 Location</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl glass-card text-foreground border border-foreground/20 focus:border-primary-blue focus:outline-none transition-colors"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="CSE" className="bg-primary-bg">CSE</option>
                        <option value="SWE" className="bg-primary-bg">SWE</option>
                        <option value="EEE" className="bg-primary-bg">EEE</option>
                        <option value="BBA" className="bg-primary-bg">BBA</option>
                        <option value="English" className="bg-primary-bg">English</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full px-4 py-3 rounded-xl glass-card text-foreground border border-foreground/20 focus:border-primary-blue focus:outline-none transition-colors resize-none"
